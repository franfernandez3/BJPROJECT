# Project BlackJack Fran Fernández

import tkinter as tk
from tkinter import PhotoImage, messagebox
import random

class Card: # We define the card classes, and later we obtain the numeric values of the cards.
...
class Deck: # We now define the deck classes.
...
class EnglishDeck(Deck): # We now define again with our __init__ code the suits and we give values to the cards
    def __init__(self):
...
class Player: # We define the player
...
# With this code its supossed to start working. 